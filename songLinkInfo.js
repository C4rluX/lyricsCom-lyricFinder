...
const scrape = async (link = "") => {
    ...
    if (typeof link !== "string") {
        throw "Invalid link, must be a string"
    }
    ...
    let songLink;
    if (link.startsWith("https://www.lyrics.com/lyric/")) {
        songLink = link;
    } else if (link.startsWith("http://www.lyrics.com/lyric/")) {
        songLink = link.replace("http://www.lyrics.com/lyric/", "https://www.lyrics.com/lyric/");
    } else if (link.startsWith("www.lyrics.com/lyric/")) {
        songLink = "https://" + link;
    } else if (link.startsWith("lyrics.com/lyric/")) {
        songLink = "https://www." + link;
    } else {
